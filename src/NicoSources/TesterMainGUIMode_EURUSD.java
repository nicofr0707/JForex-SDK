...
public class TesterMainGUIMode_EURUSD extends JFrame implements ITesterUserInterface, ITesterExecution {
   ...
   // private String strDateTo = "2007/06/01 00:00:00";
    ...
    R_CurrencyIndexRobotFX20140102_EURUSD_mvn strategy1;
    LoadingProgressListener loadingProgressListener;

    public TesterMainGUIMode_EURUSD(List<String> _optimizationList,String _fromDate, String _toDate, String _destWriteFolder) {
        ...
        if (this.currentChartPanel != null) {
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    @Override
                    public void run() {
                        TesterMainGUIMode_EURUSD.this.getContentPane().remove(TesterMainGUIMode_EURUSD.this.currentChartPanel);
                        TesterMainGUIMode_EURUSD.this.getContentPane().repaint();
                    }
                });
            } catch (Exception e) {
                LOGGER.error(e.getMessage(), e);
    ...
    private void startLoopStrategies(int paramIndex, final ITesterClient _client) {
        ...
        strategy1 = new R_CurrencyIndexRobotFX20140102_EURUSD_mvn();
