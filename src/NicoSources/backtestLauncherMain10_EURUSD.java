 ...
 * @author Nicolas
 */
public class backtestLauncherMain10_EURUSD {

    private static final Logger LOGGER = LoggerFactory.getLogger(TesterMainGUIMode.class);

    private static int usedPeriodsConfig_Start = 3;
    private static int usedPeriodsConfig_End = 4;
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            destWriteFolder = "C:/Users/Nicolas/Documents/JForex/Strategies/JForexStrategies/reports/currencyIndex2014/XMLWriteTmp_MVN/EURUSD/";
        }
        ...
        try {
            ...
            TesterMainGUIMode_EURUSD testerMainGUI = new TesterMainGUIMode_EURUSD(optimizationList, fromDate, toDate, destWriteFolder);
        } catch (Exception ex) {
